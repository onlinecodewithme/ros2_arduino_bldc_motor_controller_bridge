...
# Run the improved navigation system with enhanced Arduino motor bridge
# This script provides better error handling and reconnection capabilities

set -e  # Exit on error

echo "===================================================="
echo "Starting Improved Robot Navigation System"
echo "===================================================="
...
SERIAL_PORT="/dev/ttyACM1"  # Updated to use the correct Arduino port
USE_RVIZ="true"
...
# Launch the system
echo "===================================================="
echo "Starting navigation system with improved Arduino bridge..."
echo "===================================================="
...
# Launch the navigation system with improved Arduino bridge
# First ensure PYTHONPATH includes our workspace
export PYTHONPATH=$PYTHONPATH:~/ros2_ws_arduino/src/arduino_motor_bridge

echo "Starting improved navigation with enhanced Arduino handling..."
ros2 launch robot_navigation improved_navigation.launch.py \
