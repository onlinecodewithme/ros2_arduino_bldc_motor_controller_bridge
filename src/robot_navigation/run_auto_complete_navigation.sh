...
# Script to run navigation system with RViz using the auto-detecting Arduino bridge
...
# Launch auto_complete_navigation with all components
ros2 launch robot_navigation auto_complete_navigation.launch.py \
  use_rviz:=true
