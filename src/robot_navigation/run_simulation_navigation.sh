...
# Run navigation with simulated odometry to provide visualization feedback
# This script builds the necessary packages and launches the navigation system with virtual odometry
...
# Launch the system
echo "===================================================="
echo "Starting navigation system with simulated odometry..."
echo "===================================================="
...
echo ""
echo "The robot should now move in RViz thanks to the simulated odometry,"
echo "while still sending actual motor commands to the Arduino."
echo ""
echo "Press Ctrl+C to stop the navigation system"
echo "===================================================="

# Launch the navigation system with simulated odometry
ros2 launch robot_navigation simulation_navigation.launch.py \
