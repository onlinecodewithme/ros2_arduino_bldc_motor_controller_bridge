...
class EncoderOdometryNode(Node):
    """
    Node to handle high-resolution E38S encoder data from Arduino.
    
    This specialized node provides more accurate odometry based on the
    E38S 1000B G24N encoders (4000 counts per revolution). It broadcasts
    TF transforms and publishes odometry messages for navigation.
    """
    ...
    def __init__(self):
        ...
        self.get_logger().info("E38S Encoder Odometry Node initialized")
